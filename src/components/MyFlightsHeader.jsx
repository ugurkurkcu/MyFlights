      ...
      <div className="flex space-x-2 p-2 rounded-lg">
        {["Times", "Stops", "Airlines", "Airports", "Amenities"].map(
          (filter, idx) => (
            <button
              key={idx}
              className="px-4 py-2 max-lg:px-2 max-lg:py-1 border border-gray-300 rounded-md text-sm bg-white hover:bg-gray-100"
            >
              {filter}
            </button>
          )
        ...
        <button className="px-4 py-2 max-lg:px-2 max-lg:py-1 text-blue-600 flex items-center space-x-1 rounded-md">
